            ...
            (
                <MobileHomeStyle>
                    ...
                    <div className='container'>
                        ...
                        <div className='plans'>
                            ...
                            <div className='planSection'>
                                <div className='col col1' id='col1'>
                                    ...
                                    <Link to={'/deposit'}><Button primary className='btn'  style={{backgroundColor: 'orange', marginLeft: '75px', border: '2px solid orange', color: 'rgb(36, 35, 35)'}}>{t('Invest Now')}</Button></Link>
                                </div>
                        ...
                        <div className='fixedImage2'><h1 style={{color: 'grey'}}>Ultrex<span>Gold</span> <br /> International</h1></div>
                ...
                <HomeStyle>
                    <marquee behavior="" direction="" width='300px'>UltrexGold International</marquee>
                        ...
                        <div className='plans'>
                            ...
                            <div className='planSection'>
                                <div className='col col1'>
                                    ...
                                    <Link to={'/deposit'}><Button primary className='buyGoldBtn'  style={{paddingTop: '20px', paddingBottom: '20px', paddingLeft: '45px', paddingRight: '45px', marginTop: '30px', borderRadius: '40px', fontSize: '20px', backgroundColor: 'orange', border: '2px solid orange', color: 'rgb(36, 35, 35)'}}>{t('Invest Now')}</Button></Link>
                                </div>
                                <div className='col col2'>
                                    <h2>5%</h2>
                                    <h4>{t('Daily for 5 days')}</h4>
